...
## тут можно было использовать mkdir -p, но если надо будет обрабатывать код возврата то будет не так удобно, но было бы короче:
##
## mkdir -p task/dir1
## mkdir task/dir2
...
## А вот такой вариант почему-то не сработал, $1 заменилось на "", наверное надо как-то экранировать
